...
_SLIDERS = [
    ...
    ('OMEGA_SRV',   'omega_srv',   100,    41253,   100,    15000,   [(100,'100'),(10000,'10k'),(15000,'15k'),(30000,'30k'),(41253,'41k')]),
    ...
    ('EPSB',        'epsB',        -5,     -1,      0.05,   -3.4,    [(-5,'-5'),(-4,'-4'),(-3.4,'-3.4'),(-2,'-2'),(-1,'-1')]),
    ...
    ('FDEC_LOG',    'fdec_log',    -6,     6,       0.01,   -0.73,   [(-6,'-6'),(-3,'-3'),(-0.73,'-0.73'),(3,'3'),(6,'6')]),
