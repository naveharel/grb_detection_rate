...
_SLIDERS = [
    ...
    ('OMEGA_SRV',   'omega_srv',   100,    41253,   100,    41253,   [(100,'100'),(10000,'10k'),(15000,'15k'),(30000,'30k'),(41253,'41k')]),
    ('QMIN',        'qmin',        0,      14.5,    0.01,   0,       [(0,'0'),(1,'1'),(2,'2'),(5,'5'),(10,'10'),(14.5,'14.5')]),
    ('DMIN',        'Dmin',        0,      12,      0.01,   0,       [(0,'0'),(1,'1'),(4.55,'4.55'),(8,'8'),(12,'12')]),
    ('SFADE',       'sfade',       0,      2,       0.05,   0,       [(0,'0'),(0.3,'0.3'),(0.5,'0.5'),(1,'1'),(2,'2')]),
    ('SRISE',       'srise',       0,      2,       0.05,   0,       [(0,'0'),(0.3,'0.3'),(0.5,'0.5'),(1,'1'),(2,'2')]),
    ('TNIGHT',      'tnight',      1,      24,      0.25,   10,      [(1,'1'),(4,'4'),(8,'8'),(10,'10'),(14,'14'),(18,'18'),(24,'24')]),
    ('P',           'p',           2.01,   3,       0.01,   2.2,     [(2.01,'2'),(2.2,'2.2'),(3,'3')]),
    ...
    ('NSLICE_TFIX', 'nslice-tfix', 2,      8,       0.001,  4.936514,
        [(2,'100 s'),(3.556303,'1 hr'),(4.936514,'1 day'),(5.237544,'2 day'),(5.781612,'1 wk'),(7.498807,'1 yr')],
        'nslice-tfix-slider',
        # log10(seconds) — reachable values (densely populated, includes all
        # original anchors: 100 s, 10 min, 30 min, 1 hr, 3 hr, 6 hr, 12 hr,
        # 1 day, 2 day, 3 day, 1 wk, 2 wk, 1 mo, 3 mo, 1 yr).  Day-scale stops
        # are round(log10(n·86400), 6) so optical mode (integer nights only)
        # lands on the labelled cadence to <0.01% (the bridge snap carries a
        # matching tolerance); sub-day and fractional-day stops serve
        # non-optical mode.
        [2.000000,  # 100 s
         2.301030,  # 200 s
         2.477121,  # 5 min
         ...
         4.811575,  # 18 hr
         4.936514,  # 1 day
         5.112605,  # 1.5 day (non-optical only; optical snaps to 2 day)
         5.237544,  # 2 day
         5.413635,  # 3 day
         5.538574,  # 4 day
         5.635484,  # 5 day
         ...
         6.082642,  # 2 wk
         6.258733,  # 3 wk
         6.413635,  # 1 mo (30 day)
         6.559763,  # 6 wk (42 day)
         6.714665,  # 2 mo (60 day)
         6.890756,  # 3 mo (90 day)
         7.015695,  # 4 mo (120 day)
         7.191786,  # 6 mo (180 day)
         7.367878,  # 9 mo (270 day)
         7.498807]), # 1 yr (365 day)
    ('TSLICE_NFIX', 'tslice-nfix', 0,      4,       0.001,  2.0,
        ...
        [0.000,   # 1
         ...
         3.845,   # 7k
         4.000]), # 10k
    # qdview big sliders — shared between the R(q) and R(D) panels. Same range
    # and discrete set as TSLICE_NFIX / NSLICE_TFIX so the strategy domain is
    # identical across slice and qdview modes.
    ('QDVIEW_NFIX', 'qdview-nfix', 0,      4,       0.001,  2.0,
        [(0,'1'),(1,'10'),(2,'100'),(3,'1k'),(4,'10k')],
        'qdview-nfix-slider',
        [0.000, 0.301, 0.477, 0.699, 0.845, 1.000, 1.176, 1.301, 1.477, 1.699,
         1.845, 2.000, 2.176, 2.301, 2.477, 2.699, 2.845, 3.000, 3.176, 3.301,
         3.477, 3.699, 3.845, 4.000]),
    ('QDVIEW_TFIX', 'qdview-tfix', 2,      8,       0.001,  4.936514,
        [(2,'100 s'),(3.556303,'1 hr'),(4.936514,'1 day'),(5.237544,'2 day'),(5.781612,'1 wk'),(7.498807,'1 yr')],
        'qdview-tfix-slider',
        [2.000000, 2.301030, 2.477121, 2.778151, 2.954243, 3.079181, 3.255273,
         3.431364, 3.556303, 3.732394, 3.857332, 4.033424, 4.158362, 4.334454,
         4.459392, 4.635484, 4.811575, 4.936514, 5.112605, 5.237544, 5.413635,
         5.538574, 5.635484, 5.781612, 5.936514, 6.082642, 6.258733, 6.413635,
         6.559763, 6.714665, 6.890756, 7.015695, 7.191786, 7.367878, 7.498807]),
]
