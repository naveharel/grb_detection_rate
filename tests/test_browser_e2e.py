...
_COMPUTE_TIMEOUT_MS = 90_000  # exact-mode payloads are slower than the dominant-term default,
                               # and this branch's N_v>1 schedule adds a heavier gap-averaged
                               # mixture computation on top under Pyodide's WASM numpy
